...
export const sampleRows = [
  ...
  { id: 'CLM-1043', customer: 'Ben Whitfield', amount: 0, status: 'Closed', submitted: '2026-08-09', assignee: 'S. Patel', priority: 'Low', variance: 0, region: 'VIC', channel: 'Email', updated: '2026-08-20', notes: 'Duplicate submission, closed with no action.', footnotes: { amount: 'No payout: duplicate submission.' } },
