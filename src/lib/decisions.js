...
export const decisions = [
  ...
  },
  {
    ...
    options: [
      { label: 'Full date (day, text month, year) plus 12-hour time with an explicit AM/PM, plus a timezone abbreviation', chosen: true, note: 'A text month sidesteps the US-vs-world day/month ordering ambiguity entirely, no date is more readable with an explicit AM/PM than without one, and a bare time is meaningless without knowing whose clock it\u2019s on: someone in a different timezone can\u2019t tell if it\u2019s stale without one. The month itself is an explicit 3-letter list rather than a locale-formatted one, since en-AU and en-GB both give September as "Sept" while every other month is 3 characters, a real convention but one that breaks the uniform width a table needs.' },
