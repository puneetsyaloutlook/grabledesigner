...
export const decisions = [
  ...
  },
  {
    ...
    options: [
      { label: 'An em dash for not-applicable, "0" written out for zero', chosen: true, note: 'Visually quiet in a dense numeric column while keeping all three states distinguishable, including to screen readers.' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Red text colour alone', chosen: false, note: 'Rejected outright \u2014 colour as the only signal fails the same not-colour-alone requirement selection state has to meet.' },
    ],
